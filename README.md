...
Function names, function variable names, and constants names can only contain a-z A-Z 0-9 and must has at least 1 character. 
...
Be careful that if other functions or constants reference to a delete function/constant, they will return NaN when being called.  
