...
public class Constant extends Element
{
	 ...
	 * @return
	 */
	public static boolean createConstant(String name, Element e)
	{
		...
		{
			userDefinedConstants.add(new Constant(name, e, true, true));
			return true;
		}
		else
		{
	...
	{
		return createConstant(name, Interpreter.interpret(Standardizer.standardize(expression)));
	}
	
	public static boolean createConstant(String name, double value)
	{
		return createConstant(name, new Value(value));
	}
	 ...
	 * @return
	 */
	public static boolean modifyConstant(String name, Element e)
	{		
	...
	{
		return modifyConstant(name, Interpreter.interpret(Standardizer.standardize(expression)));
	}
	
	public static boolean modifyConstant(String name, double value)
	{
		return modifyConstant(name, new Value(value));
	}
